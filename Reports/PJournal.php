...
<center>
  <font size="+1"><b><u>Purchase Journal</u></b></font>
</center>
<br>

<form action="Accounting/PJournal.php" method="post" name="frmrep" id="frmrep" target="_blank">
  ...
  $(function(){
    ...
    $('.datepick').datetimepicker({
      ...
      $('#btnxls').on('click', function(){
        $('#frmrep').attr("action", "Accounting/PJournal_xls.php");
        $('#frmrep').submit();
      })
      $('#btnsales').on('click', function(){
      $('#frmrep').attr("action", "Accounting/PJournal.php");
      $('#frmrep').submit();
      })
  });
