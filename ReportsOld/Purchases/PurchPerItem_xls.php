...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Purchases_Per_Item');
...
header('Content-Disposition: attachment;filename="Purchases_Per_Item.xlsx"');
