...
<table width="100%" border="0" cellpadding="3" style="border-collapse:collapse;" id="tblMain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="5">
      <tr>
        ...
        <?php
        	if($lPrintPosted==1){
				echo "<font color='#FF0000'><b><i>ORIGINAL RR ALREADY PRINTED<i></b></font>";
			}
		?>
        </td>
      </tr>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" style="border-style:dashed;">
      ...
      <?php 
		$sqlbody = mysqli_query($con,"select a.*,b.citemdesc from receive_t a left join items b on a.compcode=b.compcode and a.citemno=b.cpartno where a.compcode='$company' and a.ctranno = '$cpono'");
...
//Update items table cost, retailcost and stockonhands
		$UpdateItem = mysqli_query($con,"Select A.citemno, B.citemdesc, A.nqty as nqtyin, A.nfactor as nfactorin, A.ncost, A.nretail, B.nqty, B.npurchcost, B.nretailcost From receive_t A left join items B on A.compcode=B.compcode and A.citemno=B.cpartno Where A.compcode='$company' and A.ctranno='$cpono'");
