<?php 
    ...
    $sql = "SELECT a.ncredit, a.cewtcode, a.newtrate, a.ctranno, b.ngross, b.dapvdate, c.cname, CONCAT_WS(', ', c.chouseno, c.ccity) as caddress, c.ctin, d.cdesc, MONTH(b.dapvdate) as dmox
    FROM apv_t a
