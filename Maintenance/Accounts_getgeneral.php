...
$result = mysqli_query ($con, "select cacctno as id, cacctdesc as title, IFNULL(mainacct,0) as parent_id from accounts WHERE ccategory = '".$_REQUEST["Id"]."' and ctype='General' order by cacctno"); 
