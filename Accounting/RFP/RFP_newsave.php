<?php
	...
	if (!mysqli_query($con, "INSERT INTO `rfp`(`compcode`, `ctranno`, `ccode`, `cpaymethod`, `cbankcode`, `capvno`, `dtransdate`, `cpreparedby`) values('$company', '$cSINo', '$cCustID', '$paymeth', '$cBankCode', '$cRefAPV', STR_TO_DATE('$dDate', '%m/%d/%Y'), '$preparedby')")) {
