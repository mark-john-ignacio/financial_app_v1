...
include('../../include/denied.php');
	...
	$sqlauto = mysqli_query($con,"select cvalue from parameters where compcode='$company' and ccode='AUTO_POST_PR'");
...
function Print(tranno){
	location.href = "PurchRet_postprint.php?tranno="+tranno;
}
function PrintRed(x){
	location.href = "PurchRet_print.php?x="+x;
}
