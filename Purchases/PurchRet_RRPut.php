...
<script type="text/javascript">
{
	...
	x.innerHTML = "<div class='col-xs-12'><input type='text' value='<?php echo $row['nprice'];?>' class='form-control input-xs' style='text-align:right' name='txtnprice"+lastRow+"' id='txtnprice"+lastRow+"' readonly ></div>";
	y.innerHTML = "<div class='col-xs-12'><input type='text' value='<?php echo $row['namount'];?>' class='form-control input-xs' style='text-align:right' name='txtnamount"+lastRow+"' id='txtnamount"+lastRow+"' readonly></div> <input type='hidden' value='<?php echo $row['ncost'];?>' name='txtncost"+lastRow+"' id='txtncost"+lastRow+"'> <input type='hidden' value='<?php echo $row['nretail'];?>' name='txtnretail"+lastRow+"' id='txtnretail"+lastRow+"'>";
