...
$spreadsheet->setActiveSheetIndex(0)
    ->setCellValue('A2', 'Transaction No.')
    ->setCellValue('B2', 'Date')
		->setCellValue('C2', 'Supplier')
		->setCellValue('E2', 'Total Amount');
...
// Rename worksheet
$spreadsheet->getActiveSheet()->setTitle('Purchases_Sum_Transaction');
...
header('Content-Disposition: attachment;filename="Purchases_Sum_Transaction.xlsx"');
