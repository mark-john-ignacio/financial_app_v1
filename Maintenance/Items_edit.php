        ...
        <div id="menu1" class="tab-pane fade" style="padding-left:30px">
         <p>
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-1 nopadwtop">
                    <input type="text" class="form-control input-sm" id="txtretacctD" name="txtretacctD" value="<?php echo $SRetCodeID; ?>" readonly>
										<input type="hidden" id="txtretacctID" name="txtretacctID" value="<?php echo $SRetCode; ?>">
                </div>
            </div>        
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-1 nopadwtop">
                    <input type="text" class="form-control input-sm" id="txtrracctD" name="txtrracctD" value="<?php echo $WRRCodeID;  ?>" readonly>
										<input type="hidden" id="txtrracctID" name="txtrracctID" value="<?php echo $WRRCode; ?>">
                </div>
            </div>
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-1 nopadwtop">
                    <input type="text" class="form-control input-sm" id="txtdracctD" name="txtdracctD" value="<?php echo $DRCodeID; ?>" readonly>
										<input type="hidden" id="txtdracctID" name="txtdracctID" value="<?php echo $DRCode; ?>" readonly>
                </div>
            </div>
            ...
            <div class="col-xs-12">
                ...
                <div class="col-xs-3 nopadwtop">
                 ...
                 <div class="col-xs-1 nopadwtop">
                    <input type="text" class="form-control input-sm" id="txtcogacctD" name="txtcogacctD" value="<?php echo $COGCodeID; ?>" readonly>
										<input type="hidden" id="txtcogacctID" name="txtcogacctID" value="<?php echo $COGCode; ?>">
                </div>
           </div>
