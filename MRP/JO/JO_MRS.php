<?php
	...
	$sqlhead = mysqli_query($con,"Select A.*, B.Fname, B.Minit, B.Lname from invtransfer A left join users B on A.cpreparedBy=B.Userid where compcode='$company' and mrp_jo_ctranno='".$cno."'");
