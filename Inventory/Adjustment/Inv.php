		...
		<section>
         <div>
        	<div style="float:left; width:50%">
				<font size="+2"><u>Inventory Adjustment</u></font>	
            </div>
        </div>
			<br><br>
			<button type="button" class="btn btn-primary" onClick="javascript:;" id="btnSet">
          ...
          <?php
						...
						$sql = "SELECT * FROM adjustments where compcode='$company' order by ddatetime DESC";
					...
					?>
						<tr <?=(intval($row['lcancelled'])==intval(1)) ? "class='text-danger'" : "";?>>
							<td><a  <?=(intval($row['lcancelled'])==intval(1)) ? "class='text-danger'" : "";?> href="javascript:;" onClick="editfrm('<?=$row['ctranno'];?>','InvAdj_Edit.php');"><?=$row['ctranno'];?></a></td>
...
<form name="frmNew" id="frmNew" method="get" action="InvAdj_New.php">
</form>		

<form name="frmEdit" id="frmEdit" method="get" action="InvAdj_Edit.php">
