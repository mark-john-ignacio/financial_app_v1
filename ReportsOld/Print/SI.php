...
<form name="frmTran" id="frmTran" method="post" action="Print/SI_Print.php" target="_blank">
        ...
        <span class="glyphicon glyphicon-print"></span> Print
            ...
            <tbody>
				...
				$sql = "select a.*,b.cname from sales a left join customers b on a.ccode=b.cempid where lcancelled=0 and lapproved=1 and a.dcutdate between STR_TO_DATE('$date1', '%m/%d/%Y') and STR_TO_DATE('$date2', '%m/%d/%Y') ".$qry2." order by ctranno";
