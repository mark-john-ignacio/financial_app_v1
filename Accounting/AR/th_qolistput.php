...
require_once "../../Connection/connection_string.php";
		...
		if($avail==1){
			$sql = "select a.ctranno, a.citemno as cpartno, b.citemdesc, a.cunit, a.nqty as totqty, 1 as nqty, a.nprice, a.namount, a.cmainunit as qtyunit, 
			...
			$sql = "select a.ctranno, a.citemno as cpartno, b.citemdesc, a.cunit, a.nqty as totqty, a.nprice, a.namount, a.cmainunit as qtyunit,
