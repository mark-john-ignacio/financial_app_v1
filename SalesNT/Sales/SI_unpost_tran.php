<?php
	...
	$status = "True";
			...
			if (!mysqli_query($con,"Update ntsales set lapproved=0,lcancelled=0 where compcode='$company' and ctranno in ('".implode("','",$_POST["allbox"])."')")){
				$status = "False";	
			}else{
				...
				values('$rz','$preparedby',NOW(),'UNPOST','SI NON-TRADE','$compname','UnPost Record')");
				}
...
?>
				...
				<script>
					...
					window.location.href="SI_unpost.php";
				</script>
<?php
			}else{
?>
