...
<body style="padding:5px">
        ...
        <div>
        	<div style="float:left; width:50%">
				...
				<br><br>
				<button type="button" class="btn btn-primary" onClick="location.href='Journal_new.php'"><span class="glyphicon glyphicon glyphicon-file"></span>&nbsp;Create New (F1)</button>

				<?php
					if($poststat=="True"){
				?>
					<button type="button" class="btn btn-warning btn-md" onClick="location.href='Journal_unpost.php'"><span class="fa fa-refresh"></span>&nbsp;Un-Post Transaction</button>
				<?php
					}
				?>
