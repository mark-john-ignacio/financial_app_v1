<?php 
    ...
    if($_REQUEST['typ']=="POST"){
        ...
        if (!mysqli_query($con,"Update coupon set approved=1 where compcode='$company' and CouponNo='$tranno'")) {
    ...
    mysqli_query($con,"INSERT INTO logfile(`ctranno`, `cuser`, `ddate`, `cevent`,`module`, `cmachine`, `cremarks`) 
        values('$tranno','$preparedby',NOW(),'POSTED','COUPON','$compname','Post Record')");
    ...
    if($_REQUEST['typ']=="CANCEL"){
        ...
        if (!mysqli_query($con,"Update coupon set cancelled=1 where compcode='$company' and CouponNo='$tranno'")) {
    ...
    mysqli_query($con,"INSERT INTO logfile(`ctranno`, `cuser`, `ddate`, `cevent`,`module`, `cmachine`, `cremarks`) 
        values('$tranno','$preparedby',NOW(),'CANCELLED','COUPON','$compname','Cancel Record')");
