...
if($_REQUEST['typ']=="POST"){
	...
	if (!mysqli_query($con,"Update ntso set lapproved=1 where compcode='$company' and ctranno='$tranno'")) {
...
if($_REQUEST['typ']=="CANCEL"){
	...
	if (!mysqli_query($con,"Update ntso set lcancelled=1 where compcode='$company' and ctranno='$tranno'")) {
