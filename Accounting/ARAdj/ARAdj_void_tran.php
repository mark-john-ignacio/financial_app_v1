<?php
	...
	$status = "True";
			...
			if (!mysqli_query($con,"Update aradjustment set lvoid=1 where compcode='$company' and ctranno in ('".implode("','",$_POST["allbox"])."')")){
				$status = "False";	
			}else{
				...
				values('$rz','$preparedby',NOW(),'VOID','AR ADJUSTMENT','$compname','Void Record')");
				}
...
?>
				...
				<script>
					...
					window.location.href="ARAdj_void.php";
				</script>
<?php
			}else{
?>
