...
require_once "../../Connection/connection_string.php";
	...
	$result = mysqli_query ($con, "SELECT A.ctranno, A.dreceived, A.ccode, B.cname, A.ngross From suppinv A left join suppliers B on A.compcode=B.compcode and A.ccode=B.ccode Where A.compcode='$company' and A.ccode='".$_REQUEST['ccode']."' and ctranno like '%".$_REQUEST['query']."%' and A.lapproved=1 and A.lvoid=0 Order By A.dreceived DESC"); 
