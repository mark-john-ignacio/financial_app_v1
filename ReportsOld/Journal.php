...
<center><font size="+1"><b><u>Journal Entry</u></b></font></center>
<br>

<form action="Accounting/Journal.php" method="post" name="frmrep" id="frmrep" target="_blank">
  ...
  <tr>
    ...
    <td style="padding:2px">
		<div class="col-xs-5 nopadding">                
			<select id="selrpt" name="selrpt" class="form-control input-sm">
              <option value="All">All Transactions</option>
              <option value="1">Posted Transactions</option>
              <option value="0">Unposted Transactions</option>
            </select>
		</div>
   </td>
