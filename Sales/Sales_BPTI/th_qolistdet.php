...
require_once "../../Connection/connection_string.php";
	...
	if($_REQUEST['typ']=="DR"){
		$sql = "select a.nident, a.citemno,a.cunit,a.nqty,a.creference,a.crefident,ifnull(c.nqty,0) as nqty2,b.citemdesc, 1 as navail, d.ccurrencycode, d.ccurrencydesc, a.nprice, a.namount, a.nbaseamount,b.ctaxcode as cvattype, '' as nrate, d.nexchangerate
		from dr_t a 
		...
		$sql = "select a.nident, a.citemno,a.cunit,a.nqty,'' as creference,ifnull(c.nqty,0) as nqty2,b.citemdesc, 1 as navail, d.ccurrencycode, d.ccurrencydesc, a.namount, a.nprice, a.nbaseamount, d.cvattype, e.nrate, d.nexchangerate
		from quote_t a 
		left join items b on a.compcode=b.compcode and a.citemno=b.cpartno
