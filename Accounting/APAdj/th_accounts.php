...
require_once "../../Connection/connection_string.php";
	...
	$result = mysqli_query ($con, "SELECT cacctno, cacctid, cacctdesc, IFNULL(nbalance,0) as nbalance FROM accounts WHERE compcode='$company' and ".$_REQUEST['id']." like '%".$_REQUEST['query']."%'"); 
