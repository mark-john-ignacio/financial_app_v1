...
$cSINo =  mysqli_real_escape_string($con, $_REQUEST['txtctranno']);
	...
	for($z=1; $z<=$rowcnt; $z++){
		...
		mysqli_query($con,"INSERT INTO `journal_t`(`compcode`, `nidentity`, `ctranno`, `cacctno`, `ctitle`, `ndebit`, `ncredit`, `csub`, `cremarks`) values('$company', '$z', '$cSINo', '$cacctno', '$cacctdesc', $ndebit, $ncredit, $nsub, $crem)");
