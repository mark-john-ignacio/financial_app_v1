	...
	<div>
        ...
        <div>
        	<div style="float:left; width:50%">
				<font size="+2"><u>Customers Master List > Groupings</u></font>	
            </div>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				$company = $_SESSION['companyid'];
					...
					$sql = "select * from customers_groups where compcode='$company' order by cgroupno";
	  ...
	  <div class="modal-body" style="height: 20vh">
        ...
        <div class="col-xs-12">
            ...
            <select id="selgrpno" name="selgrpno" class="form-control input-sm selectpicker">
                <?php
                    $sql = "select * from `parameters` where ccode like 'CustGroup%' order by cvalue";
...
?>
	...
	function editgrp(grp,code,desc){
		var x = chkAccess('CUSGROUPS_Edit');
		...
		/*function deleteRow(xid,grp){
			$.ajax ({
				url: "../../th_delete.php",
				data: { code: xid,  id: "CustGRP", grp: grp },
				async: false,
				dataType: "text",
				success: function( data ) {
