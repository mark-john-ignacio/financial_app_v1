...
<body style="padding:5px">
	<form action="PayBill_void_tran.php" name="frmunpost" id="frmunpost" method="POST">
	
		<div>
			<section>
					<div>
						<div style="float:left; width:50%">
							<font size="+2"><u>Bills Payment List</u></font>	
						</div>
					</div>
					<br><br>
              ...
              <th>AP Date</th>
					...
					<tbody>
					<?php
						$result=mysqli_query($con,"select a.*, a.ccheckno, b.cname, e.cname as bankname
						from paybill a 
						left join bank e on a.compcode=e.compcode and a.cbankcode=e.ccode 
						left join suppliers b on a.compcode=b.compcode and a.ccode=b.ccode 
						where a.compcode='$company' and (a.lapproved=1 and a.lvoid=0) order by a.dtrandate DESC");
						
						//select a.*,b.cname from paybill a left join suppliers b on a.compcode=b.compcode and a.ccode=b.ccode left join bank e on a.compcode=e.compcode and a.cbankcode=e.ccode where a.compcode='$company' and (a.lapproved=1 or a.lcancelled=1) order by a.ddate desc");
