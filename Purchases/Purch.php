...
function editfrm(x){
	document.getElementById("txtcpono").value = x;
	document.getElementById("frmedit").submit();
}

function trans(x,num){
	var r = confirm("Are you sure you want to "+x+" PO No.: "+num);
	if(r==true){
	var page = 'Purch_Tran.php?x='+num+'&typ='+x;
	var name = 'popwin';
	var w = 100;
	var h = 100;
...
<form name="frmedit" id="frmedit" method="post" action="Purch_edit.php">
	<input type="hidden" name="txtcpono" id="txtcpono" />
</form>		
