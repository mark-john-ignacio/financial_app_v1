...
<div class="col-lg-12 nopadding" style="background-color: #f5f5f5;">
	...
	<div class="col-lg-6 nopadding">
       ...
       <div class="col-lg-12 nopadwtop">
       		<div style="height:20vh; background-color: #f5f5f5; padding:15px;">ito un</div>
       </div> 
        ...
        <div class="modal-dialog modal-pos vertical-align-center">
            <div class="modal-content">
               <div class="modal-header">
				   ...
				   <div class="row" style="padding-left:15px; padding-right:20px; height:70vh">
                        ...
                        <div class="col-sm-7 b-col nopadwleft">
                          ...
                          <div class="col-sm-12 nopadwtop2x">
                           ...
                           <div class="col-sm-12 nopadwtop">
                             ...
                             <div class="col-sm-7 nopadwleft">
                            <input type="text" class="form-control input-md nopadwright2x" name="nDicount" id="nDicount" style="text-align:right;  font-size:18px" value="0" readonly>
                             </div>
                           </div>
                           ...
                           <div class="col-sm-12 nopadwtop"> 
                                ...
                                <ul class="nav nav-pills nav-justified">
                                  <li class="active"><a href="#DiscP" data-toggle="tab">% Discount</a></li>
                                  <li><a href="#DiscC" data-toggle="tab">Coupon</a></li>
                                </ul>
                                
                                <div class="tab-content">
                                    <div class="tab-pane in fade active pre-scrollable" id="DiscP">
                                  ...
                                  <?php
									...
									?>
                                    	...
                                    	<button type="button" class="btndisc btn btn-sm btn-default" data-val="<?php echo $row['nvalue'];?>" style="width: 100%"><?php echo $row['clabel'];?></button>
                                        </div>
                                    <?php
										}
									?>
                                    ...
                                    <div class="tab-pane fade" id="DiscC">
                                      	<div class="col-sm-12 nopadwtop">
                                        	<div class="col-sm-4 nopadwtop">
                                            	COUPON CODE:
                                            </div>
                                            <div class="col-sm-8 nopadwtop">
                                                <input type="text" class="form-control input-xs nopadwright2x" name="CoupCode" id="CoupCode" autocomplete="off">
                                            </div>
                                        </div>
                                         <div class="col-sm-12 nopadwtop">
                                        	<div class="col-sm-4 nopadwtop">
                                            ...
                                            <div class="col-sm-8 nopadwtop">
                                                 <input type="text" class="form-control input-xs nopadwright2x" name="CoupAmt" id="CoupAmt" autocomplete="off">
                                            </div>
                                        </div>
                                       <div class="col-sm-12 nopadwtop">
                                        	<div class="col-sm-4 nopadwtop">
                                            ...
                                            <div class="col-sm-8 nopadwtop">
                                                 <textarea class="form-control" rows="3" id="CoupNotes" name="CoupNotes"></textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 nopadwtop">
                                        		<button type="button" class="btn btn-success btn-xs" id="btnaddcoup" name="btnaddcoup" style="width:100%">ADD COUPON</button>
                                        </div>
                                    </div>
                                </div>
                    ...
                    success: function (data) {
					  ...
					  $.each(data,function(index,item){
						  ...
						  if(parseFloat(item.nqty)<=0){
							...
							<input type=\"hidden\" name=\"txtncost[]\" id=\"txtncost[]\" value=\"0\" data-citmno=\""+item.id+"\" /> \
...
function savetran(){
	...
	var dataString = 'ccustid=' + id + '&ccustname=' + name + '&GrandTot=' + due + '&GrandPayed=' + payed + "&hdnItmTotAmt=" + totalamt +"&totchange="+totchange + '&nnet=' + net + '&ndisc=' + discnt;
