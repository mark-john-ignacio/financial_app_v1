...
require_once "../Connection/connection_string.php";
	...
	if($avail==1){
		...
		, (TRIM(TRAILING '.' FROM(CAST(TRIM(TRAILING '0' FROM B.nqty)AS char)))) AS nqty, D.cgroupdesc
		from items A 
		left join 
			(
	...
	if(mysqli_num_rows($rsd)>=1){
		...
		echo $c_prodid.",".$c_prodnme.",".$c_unit.",".$c_nqty.",".$c_qtyunit.",".$c_typ.",".$c_taxcode.",".$cacctno.",".$cacctid.",".$cacctdesc.",".$makebuy;
	} 
