	...
	<div>
        ...
        <div>
        	<div style="float:left; width:50%">
				<font size="+2"><u>Accounts Payable Voucher</u></font>	
            </div>
        </div>
			<br><br>
			<button type="button" class="btn btn-primary" onClick="location.href='APV_new2.php'"><span class="glyphicon glyphicon glyphicon-file"></span>&nbsp;Create New (F1)</button>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
              	<?php
				$sql = "select a.*,b.cname, c.cname as custname from apv a left join suppliers b on a.ccode=b.ccode left join customers c on a.compcode=c.compcode and a.ccode=c.cempid order by a.ddate DESC";
				...
				?>
 					<tr>
						<td><a href="javascript:;" onClick="editfrm('<?php echo $row['ctranno'];?>');"><?php echo $row['ctranno'];?></a></td>
 						<td><?php echo $row['ccode'];?> - <?php echo $CustName;?> </td>
