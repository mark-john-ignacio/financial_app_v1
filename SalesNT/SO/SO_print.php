...
<table width="100%" border="0" cellpadding="3" style="border-collapse:collapse;" id="tblMain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" cellspacing="5">
      <tr>
        ...
        <?php
        	if($lPrintPosted==1){
				echo "<font color='#FF0000'><b><i>ORIGINAL SO ALREADY PRINTED<i></b></font>";
			}
		?>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" style="border-style:dashed;">
      ...
      <?php 
		$sqlbody = mysqli_query($con,"select a.*,b.citemdesc from so_t a left join items b on a.citemno=b.cpartno where a.compcode='$company' and a.ctranno = '$csalesno'");
