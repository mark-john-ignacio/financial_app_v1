...
$spreadsheet->getProperties()->setCreator('Myx Financials')
    ...
    ->setTitle('Purchase Jorunal Report')
    ->setSubject('Purchase Jorunal Report')
    ->setDescription('Purchase Jorunal Report, generated using Myx Financials.')
    ->setKeywords('myx_financials purhcase_journal')
    ...
    $spreadsheet->setActiveSheetIndex(0)
        ...
        ->setCellValue('A4', 'Kind of Book: Purchase Journal')
	...
	// Rename worksheet
	$spreadsheet->getActiveSheet()->setTitle('Purchase Jorunal ');
	...
	header('Content-Disposition: attachment;filename="Purchase_Journal.xlsx"');
