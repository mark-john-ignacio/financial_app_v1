<?php
	...
	$chkSales = mysqli_query($con,"select * from quote where compcode='$company' and YEAR(ddate) = YEAR(CURDATE()) Order By ddate desc LIMIT 1");
	if (mysqli_num_rows($chkSales)==0) {
		$cSINo = "QO".$dyear."000000001";
	}
	else {
