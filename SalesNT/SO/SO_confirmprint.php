...
include('../../include/denied.php');
	...
	$csalesno = $_REQUEST['x'];
	$sqlhead = mysqli_query($con,"select a.*,b.cname from ntso a left join customers b on a.compcode=b.compcode and a.ccode=b.cempid where a.compcode='$company' and a.ctranno = '$csalesno'");
...
<table width="100%" border="0" cellpadding="3" style="border-collapse:collapse;" id="tblMain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" style="border-style:dashed;">
      ...
      <?php 
		$sqlbody = mysqli_query($con,"select a.*,b.citemdesc from ntso_t a left join items b on a.compcode=b.compcode and a.citemno=b.cpartno where a.compcode='$company' and a.ctranno = '$csalesno'");
