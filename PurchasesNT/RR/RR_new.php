...
function myFunctionadd(nqty,nprice,curramt,namount,nfactor,cmainunit,xref,nident){
	...
	tditmqty = "<td width=\"100\"> <input type='text' value='"+itmqty+"' class='numeric form-control input-xs' style='text-align:right' name=\"txtnqty\" id=\"txtnqty"+lastRow+"\" autocomplete='off' onFocus='this.select();' /> <input type='hidden' value='"+itmqtyorig+"' name=\"txtnqtyORIG\" id=\"txtnqtyORIG"+lastRow+"\"> </td>";
	...
	$('#MyTable > tbody:last-child').append('<tr>'+tditmbtn+tditmcode + tditmdesc + tditmunit + tditmqty + tditmprice + tditmbaseamount+ tditmamount + tditmdel + '</tr>');
