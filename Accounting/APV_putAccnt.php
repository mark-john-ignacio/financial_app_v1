...
$rrno = $_REQUEST['rrno'];
$bx = $_REQUEST['txtbx'];
$TotalGross = floatval($_REQUEST['totamt']);
$nDebit = 0;
$nCredit = 0;
...
{
	var tbl = window.opener.document.getElementById('MyTable2').getElementsByTagName('tr');
	var lastRow = tbl.length;

	var a=window.opener.document.getElementById('MyTable2').insertRow(-1);
...
echo "window.opener.document.getElementById('$bx').readOnly=true;";  
echo "window.opener.document.getElementById('txtcust').readOnly=true;";
echo "window.opener.document.getElementById('txtcustchkr').value='';";
echo "window.opener.document.getElementById('txtnGross').value='".$TotalGross."';";
echo "window.close();" ;
echo "</script>" ;
