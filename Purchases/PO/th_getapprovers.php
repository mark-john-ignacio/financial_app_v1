...
require_once "../../Connection/connection_string.php";
	...
	$sql = mysqli_query($con,"SELECT a.*,b.Fname,b.Minit,b.Lname,b.cemailadd FROM `purchase_trans_approvals` a left join users b on a.userid=b.Userid where a.compcode='$company' and a.cpono='$cpono' order by a.nlevel");
