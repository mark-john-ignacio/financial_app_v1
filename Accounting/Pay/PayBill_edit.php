   	  ...
   	  <legend>Bills Payment Details</legend>
				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<tr>
						...
						<div class="col-xs-12"  style="padding-bottom:2px">
								<div class='col-xs-6 nopadding'>
									<input type="text" id="txtnGross" name="txtnGross" class="numericchkamt form-control input-sm" value="<?php echo $nAmount; ?>" style="font-size:16px; font-weight:bold; text-align:right" readonly>
							</div>
						</div>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="col-xs-12 "  style="padding-left:2px <?=($cpaymeth!=="cheque") ? "; display: none" : ""?>" id="paymntrefrdet">
								<div class="col-xs-3 nopadding">
									<input type='text' class='form-control input-sm' name='txtCheckNo' id='txtCheckNo' readonly value="<?php echo $cCheckNo; ?>" />
								</div>
								<div class="col-xs-6 nopadwleft">
							...
							<div class="col-xs-12"  style="padding-left:2px <?=($cpaymeth=="cheque" || $cpaymeth=="cash") ? "; display: none" : ""?>" id="payrefothrsdet">
								<input type="text" id="txtPayRefrnce" class="form-control input-sm" name="txtPayRefrnce" value="<?php echo $cPayRefr; ?>" placeholder="Reference No.">
							</div>
						...
						<div class="col-xs-12"  style="padding-bottom:2px">
								<div class='col-xs-6 nopadding'>
									<input type="text" id="txttotpaid" name="txttotpaid" class="numericchkamt form-control input-sm" value="<?php echo $nPaid; ?>" style="font-size:16px; font-weight:bold; text-align:right" readonly>
							</div>
						</div>
						</td>
					</tr>
...
function addrrdet(ctranno,ddate,namount,npayed,ntotowed,cacctno,napplied){
...
function loadDets(){
				...
				$.ajax({
                    ...
                    success: function (data) {
                       ...
                       console.log(data);
                       $.each(data,function(index,item){
						   addrrdet(item.capvno,item.dapvdate,item.namount,item.npayed,item.nowed,item.cacctno,item.napplied);
					   });
