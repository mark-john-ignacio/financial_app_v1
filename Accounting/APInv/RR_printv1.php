<?php
    ...
    $sql = "SELECT a.*, b.*, c.Fname, c.Lname, c.Minit, IFNULL(c.cusersign,'') as cusersign FROM suppinv a
	...
	<tr>
		<td style="vertical-align: top; padding-top: 10px">
			...
			<table border="0" width="100%" style="border-collapse:collapse">
				<tr>
					<td colspan="2" align="center" style="padding-bottom: 20px">
							<font style="font-size: 24px;">Supplier Invoice</font>
					</td>
				</tr>
			...
			<table border="0" align="center" width="100%" style="border-collapse: collapse;">
				...
				<?php 
                $sql = "SELECT a.*, b.cpartno, b.citemdesc, b.cunit FROM suppinv_t a
