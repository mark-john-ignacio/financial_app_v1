                   ...
                   <thead>
                    ...
                    <tbody>
                    	...
                    	<?php
							...
							$cnt = 0;							
							while($rowdetloc = mysqli_fetch_array($sqlloc, MYSQLI_ASSOC)){
								$opttxts = $opttxts."<option value=\"". $rowdetloc['nid']."\">".$rowdetloc['cdesc']."</option>";
							}
                    	...
                    	<tr>    
                            ...
                            <td><div style="position: relative"><input type="text" name="txtexpdte" class="datepick form-control input-xs" value='<?php echo $rowdet['dexpdte'];?>'></div></td>
