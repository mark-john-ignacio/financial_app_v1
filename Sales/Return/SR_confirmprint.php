...
include('../../include/denied.php');
	...
	$csalesno = $_REQUEST['x'];
	$sqlhead = mysqli_query($con,"select a.*,b.cname from sales a left join customers b on a.compcode=b.compcode and a.ccode=b.cempid where a.compcode='$company' and a.ctranno = '$csalesno'");
...
<input type="button" value="PRINT SI" onClick="Print('<?php echo $csalesno;?>');" class="noPrint"/></div>
</div>
