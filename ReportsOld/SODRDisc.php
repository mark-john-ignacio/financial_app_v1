...
<center><font size="+1"><b><u>Discrepancy Report - SO vs DR</u></b></font></center>
<br>

<form action="Sales/SODRDisc.php" method="post" name="frmrep" id="frmrep" target="_blank">
...
<table width="100%" border="0" cellpadding="2">
  ...
  <tr>
    <td rowspan="2" valign="top" width="70" style="padding:2px">
...
<script type="text/javascript">
  $(function(){
      ...
      $('#btnView').on("click", function(){
        $('#frmrep').attr("action", "Sales/SODRDisc.php");
        $('#frmrep').submit();
      });

      $('#btnexcel').on("click", function(){
        $('#frmrep').attr("action", "Sales/SODRDisc_xls.php");
        $('#frmrep').submit();
      });
  });
</script>