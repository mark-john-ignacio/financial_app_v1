...
<center>
  <font size="+1"><b><u>Sales Journal</u></b></font>
</center>
<br>

<form action="Accounting/SJournal.php" method="post" name="frmrep" id="frmrep" target="_blank">
  ...
  $(function(){
    ...
    $('.datepick').datetimepicker({
      ...
      $('#btnxls').on('click', function(){
        $('#frmrep').attr("action", "Accounting/SJournal_xls.php");
        $('#frmrep').submit();
      })
      $('#btnsales').on('click', function(){
      $('#frmrep').attr("action", "Accounting/SJournal.php");
      $('#frmrep').submit();
      })
  });
