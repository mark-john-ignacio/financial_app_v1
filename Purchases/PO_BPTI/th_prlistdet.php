<?php
	...
	@$receiveds = array();
	$received = mysqli_query ($con, "Select x.nrefident, x.creference,x.citemno_old as citemno,sum(x.nqty) as nqty From purchase_t x left join purchase y on x.compcode=y.compcode and x.cpono=y.cpono Where x.compcode='$company' and  x.creference='".$_REQUEST['x']."' and y.lcancelled=0 and y.lvoid=0 group by x.nrefident, x.creference,x.citemno");
