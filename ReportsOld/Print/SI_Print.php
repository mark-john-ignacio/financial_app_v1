...
$cntr = $cntr + 1;
	$sqlhead = mysqli_query($con,"select a.*,b.cname from sales a left join customers b on a.ccode=b.cempid where a.compcode='$company' and a.ctranno = '$crrno'");
...
<table width="100%" border="0" cellpadding="3" style="border-collapse:collapse; <?php echo $tblstat; ?>" id="tblMain">
  ...
  <tr>
    ...
    <table width="100%" border="0" cellpadding="3" style="border-style:dashed;">
      ...
      <?php 
		$sqlbody = mysqli_query($con,"select a.*,b.citemdesc from sales_t a left join items b on a.citemno=b.cpartno where a.compcode='$company' and a.ctranno = '$crrno' Order By a.cidentity");
