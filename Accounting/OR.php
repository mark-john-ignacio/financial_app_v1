...
?>
					...
					$sqlchk = mysqli_query($con,"Select a.cvalue,b.cacctdesc From parameters a left join accounts b on a.compcode=b.compcode and a.cvalue=b.cacctno where a.compcode='$company' and a.ccode='ORDEBCASH'");
					...
					$sqlchk2 = mysqli_query($con,"Select a.cvalue,b.cacctdesc From parameters a left join accounts b on a.compcode=b.compcode and a.cvalue=b.cacctno where a.compcode='$company' and a.ccode='ORDEBCHK'");
					
					if (mysqli_num_rows($sqlchk2)!=0) {
						while($row2 = mysqli_fetch_array($sqlchk2, MYSQLI_ASSOC)){
							$nDebitchk = $row2['cvalue'];
							$nDebitchkDesc = $row2['cacctdesc'];
						}
					}else{
						$nDebitchk = "";
						$nDebitchkDesc =  "";
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table width="95%" border="0" cellpadding="0" align="right">
                  <tr>
                    <th scope="row" width="170">Default Cash Account</th>
                  ...
                  <tr>
                    <th scope="row" width="170">Default Cheque Account</th>
                    <td style="padding:2px">
                                     
                    <div class="col-xs-10"><input type="text" class="form-control input-xs" name="paydebchk" id="paydebchk" placeholder="Search Account Description..." required tabindex="1" value="<?php echo $nDebitchkDesc; ?>"> <input type="hidden" name="paydebchkid" id="paydebchkid"  value="<?php echo $nDebitchk; ?>"> </div></td>
                  </tr>
...
<div class="modal fade" id="AlertModal" tabindex="-1" role="dialog" data-keyboard="false" data-backdrop="static" aria-hidden="true">
	...
	$('#paydebchk').typeahead({
		...
		$("#setSubmit").on('click', function(){
			...
			var id2 = $("#paydebchkid").val();
			var desc2 = $("#paydebchk").val();

			var dataString = 'id='+ id + '&desc='+ desc + '&id2='+ id2 + '&desc2='+ desc2;
			if(id==''|| desc=='' || id2==''|| desc2=='')
			{
