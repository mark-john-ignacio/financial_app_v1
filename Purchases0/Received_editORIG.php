...
$(function(){
	...
	//proddesc searching	
	$("#txtsinum").autocomplete("get_ponum.php?id=nme", {
		width: 500,
		matchContains: true,
		mustMatch: true,
		//minChars: 0,
	...
	if(document.getElementById("txtcustid").value==""){
	  ...
	  if(document.getElementById("txtcustid").value==data[1]){
		...
		$("#seltype").val(data[3]);
		  ...
		  alert("PO's Supplier didn't match.");
	  }
	}
		...
		if(document.getElementById("txtcustid").value==""){
		  ...
		  if(document.getElementById("txtcustid").value==document.getElementById("txtcustchkr").value){
			 ...
			 if (document.getElementById("txtsinum").value != "") {
				...
				var url = "Received_PODetSearch.php?id="+code+"&itmn="+itm;
...
function computeamt(valz,str,keyCode){
	...
	if(keyCode==38 ||keyCode==40){
		...
		var txtqty = document.getElementById("txtnqty" + r).value;
		...
		if (text.match(pattern)==null) 
		{
			...
			var Tot = parseFloat(txtprice) * parseFloat(txtqty);
...
<body style="padding:5px" onLoad="document.getElementById('txtsinum').focus(); disabled();">
<?php
...
<form action="Received_editsave.php" name="frmpos" id="frmpos" method="post" onSubmit="return false;">
  ...
  <tr>
    <tH>RR No.:</tH>
    <td style="padding:2px"><div class="col-xs-2"><input type="text" class="form-control input-sm" id="txtctranno" name="txtctranno" width="20px" tabindex="1" value="<?php echo $ctranno;?>" onKeyUp="chkSIEnter(event.keyCode,'frmpos');"></div>
  ...
  <tr>
    ...
    <td style="padding:2px">
    	<div class="col-xs-5">
        	<input type="text" class="form-control input-sm" id="txtcust" name="txtcust" width="20px" tabindex="1" placeholder="Search Customer Name..." value="<?php echo $CustName;?>" readonly>
        </div> 
        &nbsp;&nbsp;
            ...
            <input type="hidden" id="seltype" name="seltype" value="<?php echo $SalesType;?>">
            
    </td>
    <tH width="150"><span style="padding:2px">RECEIVED DATE:</span></tH>
    <td style="padding:2px;">
     <div class="col-xs-5">
    <a href="javascript:NewCal('rec_delivery','mmddyyyy')">
  ...
  <tr>
    ...
    <tH width="150" style="padding:2px">RECEIVED TYPE:</tH>
    <td style="padding:2px">
    <div class="col-xs-5">
  ...
  <tr>
    <td colspan="4" align="right"><div id="salesstat">
      <?php
	if($lCancelled==1){
...
<tr>
 ...
 <div class="form-group">
  <div class="col-lg-9">
    ...
    <td>
    <input type="text" id="txtnGross" name="txtnGross" readonly style="text-align:right; border:none; background-color:#FFF; font-size:20px; font-weight:bold; color:#F00;" size="10" value="<?php echo $Gross;?>">
    </td>
         ...
         <div class="alt2" dir="ltr" style="
            ...
            <table id="MyTable" class="MyTable" cellpadding"3px" width="100%" border="0">
                    ...
                    <tr>
                        ...
                        <td style="width:100px; padding:1px"><input type='text' value='<?php echo $rowbody['nprice'];?>' class='form-control input-xs' style='text-align:right' name='txtnprice<?php echo $cntr;?>' id='txtnprice<?php echo $cntr;?>' onKeyup="computeamt(this.value,this.name,event.keyCode);" onkeydown="return isNumber(event.keyCode)" onBlur="chkdecimal(this.value,"<?php echo $cntr;?>");"></td>
