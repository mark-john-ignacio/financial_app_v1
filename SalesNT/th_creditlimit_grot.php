...
require_once "../Connection/connection_string.php";
	...
	elseif($varCutDate=="Semi"){
		...
		//$qry = " and b.dcutdate between '2019-03-16' and '2019-03-31'";		
	}
	...
	$sqlinvs = "Select ifnull(sum(a.namount),0) as ngross from sales_t a left join sales b on a.ctranno=b.ctranno left join items c on a.citemno=c.cpartno where a.compcode='$company' and b.lcancelled=0 and b.ccode='$id' and c.ctype='$typ' and a.ctranno <> '$tno'".$qry;
