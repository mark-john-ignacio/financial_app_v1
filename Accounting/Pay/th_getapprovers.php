...
require_once "../../Connection/connection_string.php";
	...
	$sql = mysqli_query($con,"SELECT a.*,b.Fname,b.Minit,b.Lname,b.cemailadd FROM `paybill_trans_approvals` a left join users b on a.userid=b.Userid where a.compcode='$company' and a.cpayno='$cpono' order by a.nlevel");
