<?php
    ...
    $totamt = 0;
    $sql = "SELECT a.*, b.cname,b.ctradename, b.chouseno,b.ccity,b.cstate,b.ctin, c.Fname, c.Lname, c.Minit
        FROM sales a 
     ...
     while($row = mysqli_fetch_array($query, MYSQLI_ASSOC)){
        $data = $row;
        $totamt = $totamt + floatval($row['nbasegross']);
        ...
        $xnewts = $xnewts + floatval($row['newt']);
...
<body id='body'> <!--  onload="print();" -->
        ...
        <div id='sumInWords'><span id="hwo"><?=numberTowords($totamt)?></span></div>
        <div id='sumInText' ><?=number_format($totamt,2)?></div>
        ...
        <div class="RowCont">
                ...
                <div class="Row">
                    <div class="Column" style="width: 119px; text-align: left;"><?=$tranno?></div>  
		            <div class="Column" style="width: 121px; text-align: left"> <?=number_format($totamt,2);?></div>
                </div>
        ...
        ?>
        <div id='ngrossss' ><?=number_format($totamt,2)?></div>
