...
require_once "../../Connection/connection_string.php";
	...
	$result = mysqli_query ($con, "select A.*, B.cname from apcm A left join suppliers B on A.compcode=B.compcode and A.ccode=B.ccode WHERE A.compcode='$company' and ctranno = '".$_POST['code']."'"); 
