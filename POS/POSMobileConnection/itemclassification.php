...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT itemclassification.ccode, itemclassification.cdesc, itemclassification.cstatus
            FROM groupings itemclassification
            WHERE itemclassification.compcode = ? AND itemclassification.ctype = 'ITEMCLS'";
