...
require_once "../../Connection/connection_string.php";
	...
	@$receiveds = array();
	$received = mysqli_query ($con, "Select x.nrefidentity, x.creference,x.citemno,sum(x.nqty) as nqty From receive_t x left join receive y on x.compcode=y.compcode and x.ctranno=y.ctranno Where x.compcode='$company' and  x.creference='".$_REQUEST['x']."' and y.lcancelled=0 group by x.nrefidentity, x.creference,x.citemno");
