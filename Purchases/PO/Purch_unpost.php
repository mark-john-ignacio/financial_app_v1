...
<body style="padding:5px">
	<form action="Purch_unpost_tran.php" name="frmunpost" id="frmunpost" method="POST">
		...
		<div>
			<section>
				...
				<table id="example" class="table table-hover " cellspacing="1" width="100%">
					...
					$alrr = mysqli_query($con,"Select a.creference from receive_t a left join receive b on a.compcode=b.compcode and a.ctranno=b.ctranno where a.compcode='$company' and b.lcancelled=0");
					$refpos[] = "";
					...
					$result=mysqli_query($con,"select a.*,b.cname from purchase a left join suppliers b on a.compcode=b.compcode and a.ccode=b.ccode where a.compcode='$company' and a.cpono in ('".implode("','",$allPOFor)."') order by a.ddate desc");
