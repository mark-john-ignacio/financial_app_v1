...
require_once "../Connection/connection_string.php";
	...
	$sqlinvs = "Select ifnull(sum(a.namount),0) as ngross from sales_t a left join sales b on a.ctranno=b.ctranno left join items c on a.citemno=c.cpartno where a.compcode='$company' and b.lcancelled=0 and b.ccode='$id' and c.ctype='$typ'".$qry;
