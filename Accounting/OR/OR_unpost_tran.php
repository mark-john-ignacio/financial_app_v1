<?php
	...
	$status = "True";
			...
			if (!mysqli_query($con,"Update receipt set lapproved=0,lcancelled=0 where compcode='$company' and ctranno in ('".implode("','",$_POST["allbox"])."')")){
				$status = "False";	
			}else{
				...
				values('$rz','$preparedby',NOW(),'UNPOST','AR PAYMENT','$compname','UnPost Record')");
				}
...
?>
				...
				<script>
					...
					window.location.href="OR_unpost.php";
				</script>
<?php
			}else{
?>
