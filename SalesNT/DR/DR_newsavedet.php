...
function chkgrp($valz) {
	...
	if (!mysqli_query($con,"INSERT INTO ntdr_t(`compcode`, `cidentity`, `ctranno`, `creference`, `crefident`, `nident`, `citemno`, `nqty`, `nqtyorig`, `cunit`, `nprice`, `nbaseamount`, `namount`, `cmainunit`,`nfactor`,`cacctcode`,`cacctcost`) values('$company', '$refcidenttran', '$cSINo', $crefno, $crefnoident, '$indexz', '$cItemNo', '$nQty', '$nOrigQty', '$cUnit', '$nPrice', '$nTransAmount', '$nAmount', '$cMainUOM', $nFactor,$cacctcode,$cacctcost)")){
		echo "False";
