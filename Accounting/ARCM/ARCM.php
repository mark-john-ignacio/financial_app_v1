	...
	<div>
        ...
        <div>
        	<div style="float:left; width:50%">
				<font size="+2"><u>AR Credit Memo</u></font>	
            </div>
        </div>
			<br><br>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				$sql = "select a.*,b.cname from aradj a left join customers b on a.ccode=b.cempid and a.compcode=b.compcode where a.compcode='$company' and a.ctype='Credit' order by a.ddate DESC";
