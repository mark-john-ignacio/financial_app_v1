<?php
	...
	$status = "True";
			...
			if (!mysqli_query($con,"Update aradjustment set lapproved=0,lcancelled=0 where compcode='$company' and ctranno in ('".implode("','",$_POST["allbox"])."')")){
				$status = "False";	
			}else{
				...
				values('$rz','$preparedby',NOW(),'UNPOST','AR ADJUSTMENT','$compname','UnPost Record')");
				}
...
?>
				...
				<script>
					...
					window.location.href="ARAdj_unpost.php";
				</script>
<?php
			}else{
?>
