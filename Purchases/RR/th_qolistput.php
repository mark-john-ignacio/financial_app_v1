...
require_once "../../Connection/connection_string.php";
	...
	$sql = "select a.cpono,a.nident,a.citemno,a.cunit,a.nqty,a.nfactor,a.cpono, a.nprice, a.namount, a.nbaseamount,b.ccurrencycode from purchase_t a left join purchase b on a.compcode=b.compcode and a.cpono=b.cpono WHERE a.compcode='$company' and a.cpono = '".$_REQUEST['id']."' and a.nident='".$_REQUEST['itm']."' ";
