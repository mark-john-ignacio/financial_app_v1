...
require_once "../../Connection/connection_string.php";
	...
	if($_REQUEST['typ']=="DR"){   //DELIVERY REFERENCE
		...
		//get all dr
		$resq = mysqli_query ($con, "Select ctranno, crefident as nident, citemno,nqty From dr_t where compcode='$company'");
		...
		@$arrefquotes = array();
		$resquortes = mysqli_query ($con, "Select creference From so_t where compcode='$company' and IFNULL(creference,'') <> ''");
