...
<div class="d-flex flex-column flex-root">
    <!--begin::Page-->
        <!--begin::Container-->
        <div id="kt_content_container" class="container-xxl" style="padding-bottom: 50px; background: #fff !important">
            <!--begin::FirstRow-->
                <div class="row gy-5 g-xl-10">
                    <!--begin::Col-->
                    <div class="col-lg-4 col-12 col-md-4">
                        <!--begin::Mixed Widget 13-->
                        <div class="card card-xl-stretch mb-xl-10" style="background-color: #fb9bbb">
                            <!--begin::Body-->
                    ...
                    <div class="col-lg-4 col-12 col-md-4">
                        ...
                        <div class="card card-xxl-stretch mb-xl-10" style="background-color: #67e0ed">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column">
                                <!--begin::Wrapper-->
                                <div class="d-flex flex-column flex-grow-1">
                                    <!--begin::Title-->
                                    <a href="#" class="text-dark text-hover-primary fw-bolder fs-3">Top Selling Item This Year</a>
                                ...
                                <div class="pt-10">
                                    ...
                                    <!--end::Symbol-->
                                    <!--begin::Number-->
                                    <span class="text-dark fw-bolder fs-2x me-2 lh-0"><?= topSellingItem($company)['revenue']; ?></span>
                                    <!--end::Number-->
                                    <!--begin::Text-->
                                    <span class="text-dark fw-bolder fs-7 lh-0"><?= topSellingItem($company)['percentageChange']; ?> this week</span>
                                    <!--end::Text-->
                                </div>
                                <!--end::Stats-->
                            </div>
                    ...
                    <div class="col-lg-4 col-12 col-md-4">
                        <!--begin::Mixed Widget 14-->
                        <div class="card card-xxl-stretch mb-5 mb-xl-10" style="background-color: #6b89f2">
                            <!--begin::Body-->
                            <div class="card-body d-flex flex-column ">
                                <!--begin::Wrapper-->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center mb-15 me-2">
                                            ...
                                            <!--begin::Title-->
                                            <div>
                                                <div class="fs-4 text-dark fw-bolder lh-1">₱<?= totalGrossSales($company);?></div>
                                                <div class="fs-8 text-white fw-bold">Gross Sales</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center mb-9 ms-2">
                                            ...
                                            <!--begin::Title-->
                                            <div>
                                                <div class="fs-4 text-dark fw-bolder lh-1">₱<?= totalNetSales($company); ?></div>
                                                <div class="fs-8 text-white fw-bold">Vatable Sales</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center me-2 mb-9">
                                            ...
                                            <!--begin::Title-->
                                            <div>
                                                <div class="fs-4 text-dark fw-bolder lh-1">₱<?= totalVat($company)?></div>
                                                <div class="fs-8 text-white fw-bold">Total Vat</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="d-flex align-items-center ms-2 mb-9">
                                            ...
                                            <!--begin::Title-->
                                            <div>
                                                <div class="fs-4 text-dark fw-bolder lh-1">₱<?= totalDiscount($company); ?></div>
                                                <div class="fs-8 text-white fw-bold">NonVat Sales</div>
                                            </div>
                                            <!--end::Title-->
                                        </div>
                                    </div>
            ...
            <!--begin::SecondRow-->
                <div class="row gy-5 g-xl-10">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card card-xxl-stretch-50 mb-5 mb-xl-8" style="box-shadow: 0 0 5px grey;">
                            <!--begin::Body-->
                            <div class="card-header p-0 d-flex justify-content-between flex-column overflow-hidden">
                                <!--begin::Hidden-->
                                <div class="d-flex flex-stack flex-wrap flex-grow-1 px-9 pt-5 pb-0">
                                    <div class="me-2">
                    ...
                    <div class="col-lg-6">
                        <!--begin::Sale per item-->
                        <div class="card card-xl-stretch mb-5 mb-xl-8"  style="box-shadow: 0 0 5px grey;">
                            <!--begin::Header-->
                            <div class="card-header pt-2 d-flex justify-content-between flex-column overflow-hidden">
                                <!--begin::Title-->
                                <h3 class="card-title align-items-start flex-column">
                                    <span class="card-label fw-bolder fs-3 mb-1">Sales per item</span>
                                    <span class="text-gray-400 fw-bold">Top 5</span>
                                </h3>
                                <!--end::Title-->
            ...
            <div class="row g-5 g-xl-8">
                <div class="col-lg-6">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8" style="box-shadow: 0 0 5px grey;">
                        ...
                        <div class="card-body">
                            <!--begin::Chart-->
                            <div id="purchase-per-item-bar" style="height: 285px"></div>
                            <!--end::Chart-->
                        </div>
                        <!--end::Body-->
                    </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card card-xl-stretch mb-5 mb-xl-8" style="box-shadow: 0 0 5px grey;">
                        ...
                        <div class="card-body">
                            ...
                            <div id="supplier-pie" style="height: 300px;"></div>
