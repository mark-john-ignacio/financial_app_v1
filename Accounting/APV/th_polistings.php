...
require_once "../../Connection/connection_string.php";
	...
	$resrefpay = mysqli_query($con, "Select crefno from apv_d A left join apv B on A.compcode=B.compcode and A.ctranno=B.ctranno  where A.compcode='$company' and B.captype='PurchAdv'");
