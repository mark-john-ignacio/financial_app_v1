...
$sqlhead = mysqli_query($con,"select * from receive where ctranno not in (Select ctranno from glactivity) and lapproved=1 order by ctranno");
...
?>
 ...
 <form action="uploadtran_frame.php" name="frmsend" id="frmsend" method="post">
    ...
    <input type="hidden" name="dcutdate" id="dcutdate" value="<?php echo $qty;?>" />
     ...
     <input type="hidden" name="type" id="type" value="RR" />
 </form>
