...
require_once "../../Connection/connection_string.php";
	...
	$result = mysqli_query ($con, "SELECT * FROM aradjustment WHERE compcode='$company' and ccode='".$_GET['code']."' and ctranno like '%".$_GET['query']."%' and lapproved=1 and isreturn = 0 and ".$qrytrd); 
