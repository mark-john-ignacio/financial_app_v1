	...
	<div>
        ...
        <div>
        	<div style="float:left; width:50%">
				<font size="+2"><u>Suppliers Master List > Classification</u></font>	
            </div>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				$company = $_SESSION['companyid'];
					...
					$sql = "select * from groupings where compcode='$company' and ctype='SUPCLS' order by cdesc";
...
?>
	...
	$(function(){
		...
		$("#btnadd").on("click", function() {
		 var x = chkAccess('SUPCLASS_New.php');
	...
	function editgrp(code,desc){
		 var x = chkAccess('SUPCLASS_Edit.php');
		...
		function setStat(code, stat){
			$.ajax ({
				...
				data: { code: code,  stat: stat, typz: 'SUPCLS' },
				async: false,
				success: function( data ) {
					if(data.trim()!="True"){
