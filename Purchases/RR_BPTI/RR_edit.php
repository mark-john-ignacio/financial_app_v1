...
<form action="RR_editsave.php?hdnsrchval=<?=(isset($_REQUEST['hdnsrchval'])) ? $_REQUEST['hdnsrchval'] : ""?>" name="frmpos" id="frmpos" method="post" onSubmit="return false;">
	...
	<div class="portlet">
		<div class="portlet-title">
			<div class="caption">
				<i class="fa fa-download"></i>Receiving Details
			</div>
			<div class="status">
				<?php
					if($lCancelled==1){
				...
				<div id="home" class="tab-pane fade in active" style="padding-left:5px; padding-top:10px">
					...
					<table width="100%" border="0">
						<tr>
							...
							<td  colspan="2" style="padding:2px" align="right"> <div id="statmsgz" class="small" style="display:inline"></div> </td>
						</tr>
				...
				if(isDone=="True"){
					...
					setTimeout(function() {
						...
						$.ajax({
							type: "POST",
							url: "RR_edit.php",
							data: { txtctranno:trancode },
							success: function() {   
								//location.reload();  
								window.location.href = "RR_edit.php?txtctranno="+trancode;
							}
						});
