...
require_once "../../Connection/connection_string.php";
	...
	$cpono = $_REQUEST['id'];
		...
		$sql = "select X.citemno as cpartno, A.citemdesc as citemdesc1, X.citemdesc as citemdesc2, X.cunit, X.nqty, X.nprice, X.nbaseamount, X.namount, X.cmainunit, X.nfactor, X.ddateneeded
		from purchase_t X
