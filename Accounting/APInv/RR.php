...
//POST
$poststat = "True";
$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'SuppInv_post'");
...
//CANCEL
$cancstat = "True";
$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'SuppInv_cancel'");
if(mysqli_num_rows($sql) == 0){
	$cancstat = "False";
}
