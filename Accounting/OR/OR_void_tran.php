<?php
	...
	$status = "True";
			...
			if (!mysqli_query($con,"Update receipt set lvoid=1 where compcode='$company' and ctranno in ('".implode("','",$_POST["allbox"])."')")){
				$status = "False";	
			}else{
				...
				values('$rz','$preparedby',NOW(),'VOID','RECEIVE PAYMENT','$compname','Void Record')");
				}
...
?>
				...
				<script>
					...
					window.location.href="OR_void.php";
				</script>
<?php
			}else{
?>
