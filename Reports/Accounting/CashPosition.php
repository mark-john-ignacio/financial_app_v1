<?php
	...
	//"Select acctno, sum(ndebit) as ndebit, sum(ncredit) as ncredit from glactivity where compcode='$company' and ddate < //STR_TO_DATE('$date1', '%m/%d/%Y')  and acctno in ('".implode("','",$acctslist)."') group by acctno order by acctno"
