...
<!-- BEGIN THEME STYLES -->
<link href="../Bootstrap/css/NFont.css?x=<?=time()?>" rel="stylesheet">
...
<link href="../global/themes/blue.css" id="style_color" rel="stylesheet" type="text/css"/>
...
<body class="page-header-fixed page-quick-sidebar-over-content page-full-width page-header-fixed-mobile page-footer-fixed-mobile">
	<?php
	...
	<div class="page-header-inner">
		...
		<div class="dropdown page-comname">
			<div style="display: table-cell; vertical-align: middle;">
				<font size='+3' style='color:#fff'>System Management</font>
			</div>
		</div>
		...
		<div class="page-content">
			...
			<div class="page-bar">
				<ul class="page-breadcrumb">
					...
					<li>
						<a href="#">Horizontal Mega Menu 1</a>
					</li>
				</ul>
