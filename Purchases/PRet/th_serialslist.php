...
require_once "../../Connection/connection_string.php";
		...
		$sql = "select a.creference,a.nrefidentity,a.citemno,a.nqty,a.cunit,a.cserial,a.nlocation,DATE_FORMAT(a.dexpired,'%m/%d/%Y') as dexpired,b.cdesc as locadesc
		from purchreturn_t_serials a
		left join receive_putaway_location b on a.nlocation=b.nid
