                                    ...
                                    <div class="row g-0">
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center mb-15 me-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <div class="fs-5 text-dark fw-bolder lh-1">₱<?= totalGrossSales($company);?></div>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center mb-9 ms-2">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <div class="fs-5 text-dark fw-bolder lh-1">₱<?= totalNetSales($company); ?></div>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center me-2 mb-9">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <div class="fs-5 text-dark fw-bolder lh-1">₱<?= totalVat($company)?></div>
                                        ...
                                        <div class="col-6">
                                            <div class="d-flex align-items-center ms-2 mb-9">
                                                ...
                                                <!--begin::Title-->
                                                <div>
                                                    <div class="fs-5 text-dark fw-bolder lh-1">₱<?= totalDiscount($company); ?></div>
