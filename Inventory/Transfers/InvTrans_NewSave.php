<?php
	...
	for($i = 1 ; $i<=$rwcnt ; $i++ ){
		...
		if (!mysqli_query($con,"INSERT INTO invtransfer_t(`compcode`, `ctranno`, `cidentity`, `nidentity`, `citemno`, `cunit`, `nqty1`, `nqty2`) values('$company', '$cTranNo', '$cident','$cntr', '$citemno', '$citemunit', '$citemqty', '$citemqty')")){
			//echo "Errormessage: %s\n", mysqli_error($con);
			$witherrr++;
		}
	}
