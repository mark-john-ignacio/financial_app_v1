<?php
    ...
    $controller = match($module){
        ...
        'SI' => "select a.*, c.cname, d.citemdesc, b.csalestype, b.ddate, b.cremarks from sales_t a
        ...
        'IN' => "select X.ctranno, X.creference as cref, B.ddate, X.nrefident, X.citemno as cpartno, A.citemdesc, X.cunit, X.nqty as totqty, 1 as nqty, X.nprice,  X.nbaseamount, X.namount, A.cunit as qtyunit, X.nfactor, X.ndiscount, A.ctype, X.ctaxcode, C.cname, B.csalestype
                from ntsales_t X
        ...
        'ARADJ' => "select a.*, b.ddate, b.crefsi, b.crefsr, c.cname, d.cdesc From aradjustment_t a 
        ...
        'OR' => "select a.*,b.dcutdate, e.ddate, c.cacctdesc, d.cdesc, e.cname from receipt_sales_t a 
