<?php
	...
	$posnew = "True";
	$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'MESEmployees_new'");
	if(mysqli_num_rows($sql) == 0){
		$posnew = "False";
	}

	$posedit = "True";
	$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'MESEmployees_edit'");
	if(mysqli_num_rows($sql) == 0){
		$posedit = "False";
	}
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
					<?php
						...
						$sql = "select * from mrp_operators where compcode='$company'order by cdesc";							
