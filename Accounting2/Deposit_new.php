...
<form action="Deposit_newsave.php" name="frmOR" id="frmOR" method="post">
  ...
  <tr>
    ...
    $sqlchk = mysqli_query($con,"Select a.cvalue, b.cacctdesc, IFNULL(b.nbalance,0) as nbalance From parameters a left join accounts b on a.compcode=b.compcode and a.cvalue=b.cacctno where a.compcode='$company' and a.ccode='DEPDEBIT'");
  ...
  <tr>
    ...
    <td valign="top" style="padding:2px"><div class="col-xs-8">
      <input type="text" id="txtnGross" name="txtnGross" class="form-control" value="0.00" readonly>
    </div></td>
    </tr>
  <tr>
