...
<form method="post" name="frmedit" id="frmedit" action="PM_edit.php">
	...
	$(function(){
		...
		$("#btnaddver").on("click", function() {
						  ...
						  var divcode = "<div class=\"col-xs-3 nopadding\"> <input type=\"text\" class=\"txtcode form-control input-xs\" placeholder=\"Enter code...\" ></div>";
						  var divdet = "<div class=\"col-xs-5 nopadwleft\"> <input type=\"text\" class=\"txtdesc form-control input-xs\" placeholder=\"Enter description...\" > </div>";
						  var divend = "</div>";
						  
						 // alert(divhead + divcode + divdet + divend);
						  
						  $("#TblItemver").append(divhead + divcode + divdet + divend);
