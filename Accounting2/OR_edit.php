...
?>
<form action="OR_editsave.php" name="frmOR" id="frmOR" method="post">
	<fieldset>
...
<tbody>
	...
	<?php
    	if($cPaytype=="Sales"){
			...
			$sqlbody = mysqli_query($con,"select a.*,b.dcutdate, b.ngross from receipt_sales_t a left join sales b on a.csalesno=b.csalesno and a.compcode=b.compcode where a.ctranno = '$corno' order by a.nidentity");
                  ...
                  <thead>
                  	...
                  	<?php
						...
						if($cPayMeth=="Cash"){
							...
							$sqlbody = mysqli_query($con,"select a.* from receipt_cash_t a where a.ctranno = '$corno' order by a.nidentity");
            ...
            <div class="modal-body">
            	<?php
					...
					if($cPayMeth=="Cheque"){
						...
						$sqlbody = mysqli_query($con,"select a.* from receipt_check_t a where a.ctranno = '$corno' order by a.nidentity");
