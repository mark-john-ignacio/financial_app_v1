...
$chkSales = mysqli_query($con,"select * from salesreturn where compcode='$company' and YEAR(ddate) = YEAR(CURDATE()) Order By ctranno desc LIMIT 1");
if (mysqli_num_rows($chkSales)==0) {
	$cSINo = "SR".$dmonth.$dyear."00000";
}
else {
