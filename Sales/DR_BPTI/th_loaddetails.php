...
require_once "../../Connection/connection_string.php";
	...
	if($avail==1){
		$sql = "select X.crefident, X.creference as ctranno, X.citemno as cpartno, X.cpartno as citemdesc, X.cunit, X.nqtyorig, X.nqty as totqty, 1 as nqty, X.nprice, X.nbaseamount, X.namount, A.cunit as qtyunit, X.nfactor, IFNULL(X.citemsysno,'') as citemsysno, IFNULL(X.citempono,'') as citempono, IFNULL(X.citempartname,'') as citempartname
		from dr_t X
