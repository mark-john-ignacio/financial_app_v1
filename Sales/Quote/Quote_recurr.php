...
<body style="padding:5px">
	<form action="Quote_void_tran.php" name="frmunpost" id="frmunpost" method="POST" class="form form-inline">
		...
		<div>
			<section>
				...
				<div class="col-xs-12 nopadwdown">
					...
					<div class="col-xs-3 nopadwleft">
						<div class="form-group">
							...
							<input type='text' class="form-control input-sm" id="date_trans" name="date_trans" value="<?=date('m/d/Y'); ?>" />
						</div>
				...
				<table id="example" class="table table-hover " cellspacing="1" width="100%">
					...
					$result=mysqli_query($con,"select a.*,IFNULL(b.ctradename,b.cname) as cname from quote a left join customers b on a.compcode=b.compcode and a.ccode=b.cempid where a.compcode='$company' and (a.lapproved=1 and a.lvoid=0) and quotetype='billing' and crecurrtype<>'one' and IFNULL(crecurrtype,'')<>'' order by a.ddate desc");
