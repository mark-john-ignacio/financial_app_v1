<?php
	...
	if (!mysqli_query($con, "UPDATE `rfp` set `ccode` = '$cCustID', `cpaymethod` = '$paymeth', `cbankcode` = '$cBankCode', `capvno` = '$cRefAPV', `dtransdate` = STR_TO_DATE('$dDate', '%m/%d/%Y') where`compcode` = '$company' and `ctranno` = '$cSINo'")) {
