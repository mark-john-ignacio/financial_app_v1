	...
	<tr>
		<td style="vertical-align: top; padding-top: 10px">
			...
			<table border="0" align="center" width="100%" style="padding-top: 10px">
				...
				?>
					<tr>
						<td align="right" class="tdpadx tdright" colspan="5" >111<b><?=$xlabel?>: &nbsp;&nbsp;&nbsp;<span style="border-bottom: 5px solid #000; border-bottom-style: double"><font size="2"><?php echo number_format($Gross,2);?> </font></span></b></td>						
					</tr>
				<?php
					}
				?>
