<?php
	...
	$posnew = "True";
	$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'Process_New.php'");
	if(mysqli_num_rows($sql) == 0){
		$posnew = "False";
	}

	$posedit = "True";
	$sql = mysqli_query($con,"select * from users_access where userid = '$employeeid' and pageid = 'Process_Edit.php'");
	if(mysqli_num_rows($sql) == 0){
		$posedit = "False";
	}
	...
	<div>
      ...
      <div>
        <div style="float:left; width:50%">
					<font size="+2"><u>Items Master List > Processes	</u></font>	
        </div>            
      </div>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
					<?php
						...
						$sql = "select * from items_process where compcode='$company'order by cdesc";							
