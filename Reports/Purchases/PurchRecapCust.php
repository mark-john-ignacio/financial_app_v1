...
<h2>Recapitulation Per Supplier: Purchase Register</h2>
...
$sql = "select  a.ccode, c.cname, b.acctno, b.ctitle, sum(b.ncredit) as ncredit, sum(b.ndebit) as ndebit
From receive a
...
where a.compcode='$company' and a.dreceived between STR_TO_DATE('$date1', '%m/%d/%Y') and STR_TO_DATE('$date2', '%m/%d/%Y') and a.lvoid = 0
group by a.ccode, c.cname, b.acctno, b.ctitle
order by a.ccode, sum(b.ndebit) desc";
...
?>  
          <tr <?php echo $classcode;?>>
            <td colspan="4">&nbsp;</td>
            <td align="right" class="rpttot"><?php echo (($totDebit > 0) ? $totDebit : '');?></td>
            <td align="right" class="rpttot"><?php echo (($totCredit > 0) ? $totCredit : '');?></td>
          </tr>
...
?>
          ...
          <tr class="rptGrand">
            ...
            <td align="right"><b><?php echo (($totDebitGRAND > 0) ? $totDebitGRAND : '');?></b></td>
            <td align="right"><b><?php echo (($totCreditGRAND > 0) ? $totCreditGRAND : '');?></b></td>
          </tr>
