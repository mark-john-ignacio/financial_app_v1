...
<form action="SI_newsave.php" name="frmpos" id="frmpos" method="post" onSubmit="return false;">
		...
		<div class="portlet">
			<div class="portlet-title">
				<div class="caption">
				<i class="fa fa-file-text" aria-hidden="true"></i>New Sales Invoice
				</div>
			</div>
			<div class="portlet-body">
	
				<ul class="nav nav-tabs">
					<li class="active"><a href="#home" data-toggle="tab">SI Details</a></li>
					...
					<div id="home" class="tab-pane fade in active" style="padding-left:5px; padding-top:10px;">
						...
						<table width="100%" border="0">
							<tr>
								...
								<tH width="100"><b>SI Series No.</b></tH>
							...
							<tr>
								...
								<td style="padding:2px;">
									<div class="col-xs-11 nopadding">
										<input type='text' class="form-control input-sm" id="coracleinv" name="coracleinv" value="" autocomplete="off"/>
									</div>
								</td>
...
<script type="text/javascript">
	...
	function myFunctionadd(qty,pricex,curramt,amtx,factr,cref,nrefident,citmcls){
		...
		var tditmbaseamount = "<td nowrap> <input type='text' value='"+curramtz+"' class='numeric form-control input-xs' style='text-align:right' name=\"txtntranamount\" id='txtntranamount"+lastRow+"' readonly> <input type='hidden' value='"+baseprice+"' name=\"txtnamount\" id='txtnamount"+lastRow+"'> </td>";
	...
	function openinv(typ){
			if($('#txtcustid').val() == ""){
				...
				//alert('th_qolist.php?x='+x+'&typ='+typ+'&styp='+fltrsalestyp);
