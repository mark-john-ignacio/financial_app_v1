...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <td colspan="2" style="padding:2px"><div class="col-xs-4 nopadding">
      <input type="text" class="form-control input-sm" id="txtbankacct" name="txtbankacct" tabindex="2" placeholder="Input Bank Acct No.." required autocomplete="off" />
    </div></td>
  </tr>
  <tr>
    ...
    <td colspan="2" style="padding:2px"><div class="col-xs-4 nopadding">
      ...
      <input type="text" class="form-control input-sm" id="txtcoa" name="txtcoa" tabindex="2" placeholder="Search Account Description.." autocomplete="off" />
    </div></td>
  </tr>
  <tr>
    <td><b>Next Check No.</b></td>
    <td colspan="2" style="padding:2px"><div class="col-xs-4 nopadding"><input type="text" class="form-control input-sm" id="txtchkno" name="txtchkno" tabindex="2" placeholder="Input Next Check No.." required autocomplete="off" /></div></td>
  </tr>
