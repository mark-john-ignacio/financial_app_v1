...
<body style="padding:5px" onLoad="document.getElementById('txtcsalesno').focus();">
	<div>
        ...
        <div>
			...
			<br><br>
			<button type="button" class="btn btn-primary btn-md" onClick="chktyp()"><span class="glyphicon glyphicon glyphicon-file"></span>&nbsp;Create New (F1)</button>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
              	<?php
				$sql =$sql = "select a.*,b.cname from aradj a left join customers b on a.ccode=b.cempid Where a.compcode='$company' order by a.ddate desc";;
