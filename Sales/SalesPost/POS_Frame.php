...
<frameset rows="*,*" framespacing="0" frameborder="no" border="0">
  ...
  <frame src="PVScript.php?csalesno=<?php echo $_POST['csalesno'];?>&dcutdate=<?php echo $_POST['dcutdate'];?>" name="bottomFrame" scrolling="No" noresize="noresize" id="bottomFrame" title="bottomFrame">
</frameset>
<noframes><body>
</body></noframes>
</html>
