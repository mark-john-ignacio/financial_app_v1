...
if($_REQUEST['typ']=="POST"){
			...
			if (!mysqli_query($con,"Update suppinv set lapproved=1 where compcode='$company' and ctranno='$tranno'")) {
...
mysqli_query($con,"INSERT INTO logfile(`ctranno`, `cuser`, `ddate`, `cevent`, `module`, `cmachine`, `cremarks`) 
	values('$tranno','$preparedby',NOW(),'POSTED','SUPPLIERS INVOICE','$compname','Post Record')");
...
if($_REQUEST['typ']=="CANCEL"){
	...
	if (!mysqli_query($con,"Update suppinv set lcancelled=1 where compcode='$company' and ctranno='$tranno'")) {
...
mysqli_query($con,"INSERT INTO logfile(`ctranno`, `cuser`, `ddate`, `cevent`, `module`, `cmachine`, `cremarks`) 
	values('$tranno','$preparedby',NOW(),'CANCELLED','SUPPLIERS INVOICE','$compname','Cancel Record')");
