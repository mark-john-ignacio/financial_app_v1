...
xmlhttp.open("GET","Received_PODet.php?id="+ref_no+"&itms="+citemno2,true);
xmlhttp.send();
}
     ...
     <div class="alt2" dir="ltr" style="
		...
		<tr bgcolor="#CCCCCC">
		  ...
		  $company = $_SESSION['companyid'];
				...
				$sql = "select a.*,b.cname from purchase a left join suppliers b on a.compcode=b.compcode and a.ccode=b.ccode where a.compcode='$company' and a.lapproved=1 and a.ccode='$cCustID' order by cpono";
        ...
        <tr onClick="getData('<?php echo $row['cpono']; ?>'); chkhdr('<?php echo $f1; ?>')" id="hdr<?php echo $f1; ?>">
        	<td style="cursor:pointer;"><?php echo $row['cpono']; ?></td>
        </tr>
