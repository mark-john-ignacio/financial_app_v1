...
<form action="PurchRet_newsave.php" name="frmpos" id="frmpos" method="post" onSubmit="return false;">
  ...
  <tr>
    ...
    <td style="padding:2px"><div class="col-xs-9"><input type="text" class="form-control input-sm" id="txtremarks" name="txtremarks" tabindex="2"></div></td>
    <tH width="150" style="padding:2px">RETURN DATE:</tH>
    <td style="padding:2px">
    <div class="col-xs-8">
    <input type='text' class="datepick form-control input-sm" id="rec_delivery" name="rec_delivery" value="<?php echo date("m/d/Y"); ?>" />
    </div>
    </td>
  </tr>
<!--
...
<tr>
    ...
    <td style="padding:2px">
    <input type="text" id="txtnGross" name="txtnGross" readonly value="0" style="text-align:right; border:none; background-color:#FFF; font-size:20px; font-weight:bold; color:#F00;" size="15">
    </td>
