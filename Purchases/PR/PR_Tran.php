...
function sendEmail($email,$name,$xpono){
	  ...
	  $output.='<p>This email is to notify that the PR# '.$xpono.' is waiting for your approval.</p>'; 
		$output.='<p>Thanks,</p>';
		$output.='<p>Myx Financials,</p>';

	$body = $output; 
	$subject = "Sert Technology Inc. - Purchase Order";
	...
	$mail->FromName = "Sert Technology Inc.";
