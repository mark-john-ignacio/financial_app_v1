...
//----------------------------
			...
			if(itmstat=="Posted"){
				...
				if(itmstat!="False"){ //Proceed sa insert Account Entry
					...
					$("#AlertMsg").html("<b>ERROR: </b>There's a problem generating your inventory and account entry!");
					$("#alertbtnOK").show();
					$("#OK").hide();
					$("#Cancel").hide();
					$("#AlertModal").modal('show');
...
<body style="padding:5px" onLoad="document.getElementById('txtcsalesno').focus();">
	<div>
        ...
        <div>
			...
			<br><br>
			<button type="button" class="btn btn-primary btn-md" onClick="location.href='DR_new.php'"><span class="glyphicon glyphicon glyphicon-file"></span>&nbsp;Create New (F1)</button>
			...
			<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody>
              	<?php
				$sql = "select a.*,b.cname, b.nlimit from dr a left join customers b on a.ccode=b.cempid and a.compcode=b.compcode where a.compcode='$company' order by a.ddate DESC";
