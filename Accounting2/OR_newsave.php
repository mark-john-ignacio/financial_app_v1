...
if (mysqli_num_rows($chkSales)==0) {
	...
	if (!mysqli_query($con, "INSERT INTO `receipt`(`compcode`, `ctranno`, `ccode`, `ddate`, `dcutdate`, `cpaymethod`, `cpaytype`, `cremarks`, `namount`, `cacctcode`, `cornumber`) values('$company', '$cSINo', '$cCustID', NOW(), STR_TO_DATE('$dTranDate', '%m/%d/%Y'), '$cPayMethod', '$cPayType', '$cRemarks', $nGross, '$cAcctNo', '$cORNo')")) {
...
?>
<form action="OR_edit.php" name="frmpos" id="frmpos" method="post">
