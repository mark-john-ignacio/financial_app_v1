...
<center>
<b><u><font size="+1">BIR Monthly VAT Report</font></u></b>

</center>
<br>
<form action="Accounting/MonthlyVAT.php" method="post" name="frmrep" id="frmrep" target="_blank">
...
$(function() {              
    ...
    $('#btnView').on("click", function(){
        $('#frmrep').attr("action", "Accounting/MonthlyVAT.php");
        $('#frmrep').submit();
    });

    $('#btnexcel').on("click", function(){
        $('#frmrep').attr("action", "Accounting/MonthlyVAT_xls.php");
        $('#frmrep').submit();
    });
